...
import dwarves.vs.zombies.monsters.weapons.GoboPick;
...
public class Goblin extends MonsterClass {
	...
	public void equipItems()
	{
		...
		//
		{
			...
			meta.setDisplayName(ChatColor.RED + "Gobo Armor");
			ArrayList<String> lore = new ArrayList<String>();
			lore.add(ChatColor.AQUA + "Armor to protect me Gobo!");
			meta.setLore(lore);
			...
			health.set("Amount", new NBTTagDouble(4));
